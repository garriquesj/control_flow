...
//cant print to my terminal so i am testing in codepen.NOTE FROM JASON
/*
 * Prompt 3:
 *
...
function prompt8() {
  ...
  else if (someNumber > 30 && someNumber < 60) {console.log("The number is medium sized.");} 
...
function prompt9() {
  // YOUR CODE HERE
for (let i= 0; i < starWars.length; i++) console.log (starWars[i]);
}
prompt9()
 ...
 *middle so half the array, math floor to remain a whole number.jason's note
